...
import com.live.fluppertestapplication.colorPickerDialog.model.ColorSwatch
...
class ColorPickerDialog private constructor(
    ...
    data class Builder(
        ...
        fun setColorListener(listener: (ArrayList<String>) -> Unit): Builder {
            this.colorListener = object : ColorListener {
                override fun onColorSelected(colorHex: ArrayList<String>) {
                    listener(colorHex)
                }
            }
            return this
    ...
    fun show() {
        ...
        val adapter = MaterialColorPickerAdapter(colorList,true)
...
//            }
            ...
            if(color.size!=null&&color.size>0){
